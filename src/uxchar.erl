...
to_lower(V) -> uxunidata:char_to_lower(V).
to_upper(V) -> uxunidata:char_to_upper(V).
is_lower(V) -> uxunidata:is_lower(V).
is_upper(V) -> uxunidata:is_upper(V).

comment(V) -> uxunidata:char_comment(V).
type(V) -> uxunidata:char_type(V).
...
block(V) -> uxunidata:char_block(V).
